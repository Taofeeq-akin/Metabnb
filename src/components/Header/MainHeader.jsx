      ...
      <div className={classes.main_header}>
        <div className={classes.header_content}>
          <h5 className={classes.heading_primary}>
            Rent a <span className={classes.purple_col}>Place</span> away from{" "}
            <br></br> <span className={classes.purple_col}>Home</span> in the{" "}
            <span className={classes.purple_col}>Metaverse</span>
          </h5>
